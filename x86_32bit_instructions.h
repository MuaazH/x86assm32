...
const Instruction xor_instructions[] = {
	// pf,  op,  op2,  ext,  cnt,  o1,      o2,   o3,   o4,   mnmnc,  flags
	// eax shortcuts
	{0x00, 0x34, 0x00, 0x00, 0x02, REG8_AL, IMM8, 0x00, 0x00, "xor", FLAG_2ND_IMM_OPERAND_ONLY},
	{0x66, 0x35, 0x00, 0x00, 0x02, REG16_AX, IMM16, 0x00, 0x00, "xor", FLAG_2ND_IMM_OPERAND_ONLY},
	{0x00, 0x35, 0x00, 0x00, 0x02, REG32_EAX, IMM32, 0x00, 0x00, "xor", FLAG_2ND_IMM_OPERAND_ONLY},
	// imm of all sizes
	{0x00, 0x80, 0x00, 0x06, 0x02, REG8, IMM8, 0x00, 0x00, "xor", FLAG_MODRM | FLAG_MODRM_OPCODE},
	{0x00, 0x80, 0x00, 0x06, 0x02, MEM8, IMM8, 0x00, 0x00, "xor", FLAG_MODRM | FLAG_MODRM_OPCODE},

	{0x66, 0x81, 0x00, 0x06, 0x02, REG16, IMM16, 0x00, 0x00, "xor", FLAG_MODRM | FLAG_MODRM_OPCODE},
	{0x66, 0x81, 0x00, 0x06, 0x02, MEM16, IMM16, 0x00, 0x00, "xor", FLAG_MODRM | FLAG_MODRM_OPCODE},

	{0x00, 0x81, 0x00, 0x06, 0x02, REG32, IMM32, 0x00, 0x00, "xor", FLAG_MODRM | FLAG_MODRM_OPCODE},
	{0x00, 0x81, 0x00, 0x06, 0x02, MEM32, IMM32, 0x00, 0x00, "xor", FLAG_MODRM | FLAG_MODRM_OPCODE},
	// imm 8
	{0x66, 0x83, 0x00, 0x06, 0x02, REG16, IMM8, 0x00, 0x00, "xor", FLAG_MODRM | FLAG_MODRM_OPCODE},
	{0x66, 0x83, 0x00, 0x06, 0x02, MEM16, IMM8, 0x00, 0x00, "xor", FLAG_MODRM | FLAG_MODRM_OPCODE},

	{0x00, 0x83, 0x00, 0x06, 0x02, REG32, IMM8, 0x00, 0x00, "xor", FLAG_MODRM | FLAG_MODRM_OPCODE},
	{0x00, 0x83, 0x00, 0x06, 0x02, MEM32, IMM8, 0x00, 0x00, "xor", FLAG_MODRM | FLAG_MODRM_OPCODE},
	// 8 <- 8
	{0x00, 0x32, 0x00, 0x00, 0x02, REG8, REG8, 0x00, 0x00, "add", FLAG_MODRM},
	{0x00, 0x30, 0x00, 0x00, 0x02, REG8, REG8, 0x00, 0x00, "add", FLAG_MODRM | FLAG_REVERSE_OPERANDS},
	{0x00, 0x32, 0x00, 0x00, 0x02, REG8, MEM8, 0x00, 0x00, "add", FLAG_MODRM},
	{0x00, 0x30, 0x00, 0x00, 0x02, MEM8, REG8, 0x00, 0x00, "add", FLAG_MODRM | FLAG_REVERSE_OPERANDS},
	// 16 <- 16
	{0x66, 0x33, 0x00, 0x00, 0x02, REG16, REG16, 0x00, 0x00, "add", FLAG_MODRM},
	{0x66, 0x31, 0x00, 0x00, 0x02, REG16, REG16, 0x00, 0x00, "add", FLAG_MODRM | FLAG_REVERSE_OPERANDS},
	{0x66, 0x33, 0x00, 0x00, 0x02, REG16, MEM16, 0x00, 0x00, "add", FLAG_MODRM},
	{0x66, 0x31, 0x00, 0x00, 0x02, MEM16, REG16, 0x00, 0x00, "add", FLAG_MODRM | FLAG_REVERSE_OPERANDS},
	// 32 <- 32
	{0x00, 0x33, 0x00, 0x00, 0x02, REG32, REG32, 0x00, 0x00, "add", FLAG_MODRM},
	{0x00, 0x31, 0x00, 0x00, 0x02, REG32, REG32, 0x00, 0x00, "add", FLAG_MODRM | FLAG_REVERSE_OPERANDS},
	{0x00, 0x33, 0x00, 0x00, 0x02, REG32, MEM32, 0x00, 0x00, "add", FLAG_MODRM},
	{0x00, 0x31, 0x00, 0x00, 0x02, MEM32, REG32, 0x00, 0x00, "add", FLAG_MODRM | FLAG_REVERSE_OPERANDS}
};
...
const Instruction sub_instructions[] = {
	...
	{0x00, 0x2C, 0x00, 0x00, 0x02, REG8_AL, IMM8, 0x00, 0x00, "sub", FLAG_2ND_IMM_OPERAND_ONLY},
	{0x66, 0x2D, 0x00, 0x00, 0x02, REG16_AX, IMM16, 0x00, 0x00, "sub", FLAG_2ND_IMM_OPERAND_ONLY},
	{0x00, 0x2D, 0x00, 0x00, 0x02, REG32_EAX, IMM32, 0x00, 0x00, "sub", FLAG_2ND_IMM_OPERAND_ONLY},
